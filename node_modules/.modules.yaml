...
hoistedDependencies:
  ...
  /@rollup/plugin-commonjs/26.0.3(rollup@4.62.4):
    '@rollup/plugin-commonjs': private
  /@rollup/plugin-json/6.1.0(rollup@4.62.4):
    '@rollup/plugin-json': private
  /@rollup/plugin-node-resolve/15.3.1(rollup@4.62.4):
    '@rollup/plugin-node-resolve': private
  /@rollup/plugin-replace/5.0.7(rollup@4.62.4):
    '@rollup/plugin-replace': private
  /@rollup/plugin-typescript/11.1.6(rollup@4.62.4)(tslib@2.8.1)(typescript@5.9.3):
  ...
  /@types/hoist-non-react-statics/3.3.7(@types/react@19.1.1):
...
pendingBuilds: []
prunedAt: Mon, 03 Aug 2026 20:53:20 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /@rollup/rollup-win32-x64-msvc/4.62.4
  - /fsevents/2.3.3
storeDir: /home/deck/.local/share/pnpm/store/v3
